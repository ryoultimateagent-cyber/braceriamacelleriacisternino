...
const DoveSiamo = () => {
  return (
    <section id="dovesiamo" className="section-container py-24 md:py-32 bg-white relative overflow-hidden">
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center max-w-7xl mx-auto">
             ...
             <div className="space-y-10">
                <article className="flex items-start gap-8 group">
                  ...
                  <div>
                    ...
                    <p className="text-foreground text-xl md:text-2xl font-bold tracking-tight leading-relaxed">
                ...
                <article className="flex items-start gap-8 group">
                  ...
                  <div>
                    ...
                    <div className="text-foreground text-xl md:text-2xl font-bold tracking-tight leading-relaxed">
          ...
          <AnimatedSection delay={0.2} className="lg:col-span-7 relative order-1 lg:order-2">
            <div className="aspect-square lg:aspect-video rounded-[2.5rem] overflow-hidden border-8 border-white shadow-2xl relative group">
              <iframe

  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6">
        {/* Header */}
        <SectionHeader 
          subtitle="Posizione Privilegiata"
          title="Dove Trovarci"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 max-w-7xl mx-auto items-stretch">
          ...
          <AnimatedSection delay={0.2} className="lg:col-span-5 flex flex-col justify-center">
            ...
            <div className="space-y-10 lg:space-y-12">
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-gold-light/70 text-base lg:text-xl leading-relaxed tracking-wide font-accent italic">
                    Via Belvedere, 12<br />
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <div className="text-gold-light/70 text-base lg:text-xl leading-relaxed tracking-wide font-accent italic">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-8 mt-4 sm:mt-2 opacity-100 text-fire font-bold">
                      <span>Lunedì</span>
              ...
              <div className="flex flex-col sm:flex-row gap-8">
                <div className="flex items-start gap-6 group">
                  ...
                  <div>
                    ...
                    <a href="tel:+393403824158" className="text-gold-light/70 hover:text-gold transition-colors text-base lg:text-xl font-accent italic">
                      +39 340 38 24 158
                    </a>
                  </div>
                </div>
            ...
            <div className="mt-16 pt-10 border-t border-white/5">
              <Button 
                ...
                variant="gold" 
                size="lg" 
                className="h-14 px-12 text-sm uppercase tracking-widest font-bold shadow-2xl w-full sm:w-auto"
              >
          ...
          <AnimatedSection delay={0.4} className="lg:col-span-7 relative">
            <div className="h-full min-h-[400px] rounded-2xl overflow-hidden border border-white/5 shadow-2xl relative group">
              {/* Decorative Frame */}
              <div className="absolute inset-4 border border-white/5 rounded-2xl pointer-events-none z-10 opacity-50 group-hover:opacity-100 transition-opacity" />

...
const Prenota = () => {
  return (
    <section id="prenota" className="section-container py-24 md:py-32 bg-transparent relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-8 pt-8 border-t border-white/10">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-white text-lg font-bold">Via Giuseppe Verdi 5C, Putignano (BA)</p>
                </div>
              </div>
              <div className="flex items-center gap-6">
                <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-primary">
                ...
                <div>
                  ...
                  <p className="text-white text-lg font-bold">Lun - Sab: 08:00–13:00 | 17:00–00:00</p>
                </div>
              </div>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.2} className="relative group">
            <div className="relative bg-[#0D0D0D] p-12 md:p-16 lg:p-20 rounded-[3rem] border border-white/5 shadow-2xl text-center overflow-hidden">
              ...
              <div className="w-24 h-24 bg-white/5 rounded-3xl flex items-center justify-center mx-auto mb-10 shadow-2xl border border-white/10 group-hover:scale-110 transition-transform duration-500">
                <Phone className="text-primary w-10 h-10 animate-pulse" />
              </div>
              
              <h3 className="text-3xl font-black text-white uppercase mb-6 tracking-tight">PRENOTA UN TAVOLO</h3>
              ...
              <div className="pt-10 border-t border-white/5 flex justify-center gap-12">
                <div className="text-center">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-white/40">SERVIZIO PREMIUM</span>
                </div>
                <div className="text-center">
                  <Flame className="w-6 h-6 text-primary mx-auto mb-3" />
                  <span className="text-[10px] font-black uppercase tracking-widest text-white/40">BRACE VIVA</span>
                </div>
              </div>
            </div>
